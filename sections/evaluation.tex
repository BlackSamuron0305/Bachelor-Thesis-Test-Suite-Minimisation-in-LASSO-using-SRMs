...
\begin{itemize}
  \item \textbf{SRM Compatibility (C5):} Operate directly on binary coverage-adapted SRMs $M \in \{0,1\}^{n\times m}$ without requiring language-specific structure such as CFGs~\cite{Kessel2022}.
