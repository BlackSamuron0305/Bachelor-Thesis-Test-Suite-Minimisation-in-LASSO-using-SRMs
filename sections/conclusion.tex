...
\textbf{Construct Validity:} The use of mutation scores as a proxy for fault detection capability may not accurately reflect real-world defect characteristics. Additionally, the SRM representation abstracts away temporal dependencies and test execution contexts that may be relevant for minimization.
